...
-(id) init
{
	if( (self=[super init:@"bbfish_board.png"])) {
        ...
        [b1 setData:70 trayY:10 trayW:-1 trayH:130 boardX:227 boardY:459 z:0];
        b1.anchorPoint = CGPointMake(0.0, 1.0);
        [self addChild:b1.insprite];
        [bits addObject:b1];
        Bit *b2 = [[Bit alloc] init:@"bbfish_head.png"];
        [b2 setData:160 trayY:10 trayW:-1 trayH:130 boardX:787 boardY:279 z:0];
        [self addChild:b2.insprite];
        [bits addObject:b2];
        Bit *b3 = [[Bit alloc] init:@"bbfish_fin.png"];
        [b3 setData:420 trayY:10 trayW:-1 trayH:130 boardX:276 boardY:539 z:0];
        [self addChild:b3.insprite];
        [bits addObject:b3];
        Bit *b4 = [[Bit alloc] init:@"bbfish_belly.png"];
        [b4 setData:510 trayY:10 trayW:-1 trayH:130 boardX:464 boardY:279 z:0];
